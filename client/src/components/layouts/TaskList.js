                ...
                <div className="bg-light py-2" >
                    <div className="container" >
                        <div className="row">
                            ...
                            <Task icon="fa fa-5x fa-bath" title="Evacuation d'eau pluviale / usées" description="La saison des pluies étant marquée dans nos archipels, pensez à vous équiper avec des goutières adaptées. De même que pour vos eaux usées, anticipez les mauvaises surprises. "/>
